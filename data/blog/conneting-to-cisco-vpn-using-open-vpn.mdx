---
title: 'How to connect to cisco vpn using open vpn on arch linux'
date: 2024-08-07T15:32:14Z
lastmod: '2021-02-01'
tags: ['next-js', 'tailwind', 'guide']
draft: true
summary: 'The propetry visco vpn can be challalenging when you want to connect
to a remote mathine at work, likely the is open souce alternatin called openvpn
that can be used to connect to cisco vpn'
layout: PostSimple
